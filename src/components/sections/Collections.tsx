...
const collections: {
  ...
  {
    title: "Flores",
    description: "Estampados florales llenos de color",
    slug: "flores",
  ...
  {
    title: "Changos",
    description: "Divertidos prints de changos",
    slug: "changos",
    pattern: printPuntosAzul,
  },
  {
    title: "Para Pintar",
    description: "Diseños listos para colorear",
    slug: "para-pintar",
  ...
  {
    title: "Hongos",
    description: "Estampados de hongos mágicos",
    slug: "hongos",
